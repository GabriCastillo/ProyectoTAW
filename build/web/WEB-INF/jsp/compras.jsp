<%-- 
    Document   : compras
    Created on : 06-may-2022, 16:28:05
    Author     : frees
--%>
     ...
     <section id="subastas" style="box-sizing:content-box">
            ...
            <div style="display:flex;margin-top: 20px;margin-bottom: 20px">
                ...
                <div style="text-align: center;width:20%;margin-top: 50px">
                    ...
                    <a style="color:white">Compradador : <%= subasta.getComprador().getNombre() %></a>
                    <% 
                    }else{
                    %>
                    <form>
                    <a id="valor"><%= subasta.getPrecio_salida() %></a> €</br>
                    <input id="slider" name="slider" type="range"  onchange="valor(this.value)"min=<%= subasta.getPrecio_salida() %> max=<%= subasta.getPrecio_Compra() %>  value=<%= subasta.getPrecio_salida() %> data-rangeslider>
                    
                    <a  href="ComprarPujaServlet?id=<%= subasta.getIdCompradorProductoDTO() %>"  id="btn" type="button" value="Cerrar Puja" >Pujar</a>
                    </form>
                    <%
                    }
                     %>
