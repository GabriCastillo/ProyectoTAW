...
<html>
    ...
    <body>
        ...
        <form method="post" action="UsuarioServlet">
            Nombre: <input type="text" name="findByName" value="" />
        ...
        <table border="1">
            ...
            <tr>
                ...
                <td><a href="EstadisticaBorrarServlet?id=<%= estadistica.getIdestadistica()%>">Borrar</a></td>  
            </tr>
        ...
        <a href="EstadisticaNuevoServlet">Crear nueva estadistica ... </a>
