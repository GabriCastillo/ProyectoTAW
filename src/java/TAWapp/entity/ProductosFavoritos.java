...
public class ProductosFavoritos implements Serializable {
    ...
    private Collection<EstadisticaHasProductosFavoritos> estadisticaHasProductosFavoritosCollection;
    ...
    @XmlTransient
    public Collection<EstadisticaHasProductosFavoritos> getEstadisticaHasProductosFavoritosCollection() {
        return estadisticaHasProductosFavoritosCollection;
    }

    public void setEstadisticaHasProductosFavoritosCollection(Collection<EstadisticaHasProductosFavoritos> estadisticaHasProductosFavoritosCollection) {
        this.estadisticaHasProductosFavoritosCollection = estadisticaHasProductosFavoritosCollection;
    }
