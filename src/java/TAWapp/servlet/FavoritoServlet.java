...
@EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<CompradorProductoDTO> listaSubastas = this.subastaService.listaproductosFavoritos(productos);  
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/MisFavoritos.jsp").forward(request, response);
