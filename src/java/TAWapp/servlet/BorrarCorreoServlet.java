 ...
 *
 */
@WebServlet(name = "BorrarCorreoServlet", urlPatterns = {"/BorrarCorreoServlet"})
public class BorrarCorreoServlet extends SampleTAWServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (super.comprobarSession(request, response)) {
            int correoID = Integer.parseInt(request.getParameter("CorreoBORRAR"));
            
            this.correoService.borrarCorreo(correoID);
            
            request.getSession(false).setAttribute("idUsuarioCORREO", request.getParameter("idUsuarioPASS"));
