...
public class ProductoGuardarServlet extends TAWappServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (super.comprobarSession(request, response)) {
            ...
            if (strId == null || strId.isEmpty()) {    // Crear nuevo producto
                productoService.crearProducto(Titulo,  descripcion,  URL,  categoria, idUsuario);
            } else {                               // Editar producto
               productoService.modificarProducto(Integer.parseInt(strId),Titulo,  descripcion,  URL,  categoria, idUsuario);
            }
