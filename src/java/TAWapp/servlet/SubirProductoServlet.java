...
public class SubirProductoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //ProductoDTO pro = this.ps.crearProductoID(titulo, descripcion,imagen,categoria,user);
         Producto pro = this.ps.crearProductoID2(titulo, descripcion,imagen,categoria,user);
        System.out.print(pro.getIdproducto());
