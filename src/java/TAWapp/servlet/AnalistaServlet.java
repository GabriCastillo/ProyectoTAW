...
public class AnalistaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String texto = request.getParameter("textobarrabusqueda");
        
        session.setAttribute("EstadisticaBuscada", texto);
        
        List<Estadistica> estadisticas = estadisticaFacade.findByTitulo(texto);
